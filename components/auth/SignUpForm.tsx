...
import { createUser, findUserByEmail, setStoredUserId } from '@/lib/usersAuth'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <p className="text-center text-sm text-white/60">
        Akkauntingiz bormi?{' '}
        <Link href="/sign-in" className="font-semibold text-[#edb458] transition-colors hover:text-white">
          Sign in
        </Link>
      </p>
    </form>
